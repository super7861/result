...
$qery = "SELECT   tblstudents3.StudentName, tblstudents3.RollId, tblstudents3.RegDate, tblstudents3.StudentId, tblstudents3.Status, tblstudents3.DOB, tblclasses3.ClassNameNumeric, tblclasses3.ClassName
         FROM tblstudents3
         JOIN tblclasses3 ON tblclasses3.id=tblstudents3.ClassId
         WHERE tblstudents3.RollId=:rollid AND tblstudents3.ClassId=:classid OR tblstudents3.DOB=:dob"; // Add condition for DOB
...
// Code for result
 ...
 $query ="select t.StudentName,t.RollId,t.ClassId,t.marks,SubjectId,tblsubjects3.SubjectName from (select sts.StudentName,sts.RollId,sts.ClassId,tr.marks,SubjectId from tblstudents3 as sts join  tblresult3 as tr on tr.StudentId=sts.StudentId) as t join tblsubjects3 on tblsubjects3.id=t.SubjectId where (t.RollId=:rollid and t.ClassId=:classid)";
