...
$mark=$_POST['marks'];
 ...
 $stmt = $dbh->prepare("SELECT tblsubjects2.SubjectName,tblsubjects2.id FROM tblsubjectcombination2 join  tblsubjects2 on  tblsubjects2.id=tblsubjectcombination2.SubjectId WHERE tblsubjectcombination2.ClassId=:cid order by tblsubjects2.SubjectName");
...
for($i=0;$i<count($mark);$i++){
    $mar=$mark[$i];
  $sid=$sid1[$i];
$sql="INSERT INTO  tblresult2(StudentId,ClassId,SubjectId,marks) VALUES(:studentid,:class,:sid,:marks)";
...
{
$error="Result info added successfully";
}
}
}
?>
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Declare Internal test-II</h2>
...
<?php $sql = "SELECT * from tblclasses2";
$query = $dbh->prepare($sql);
$query->execute();
...
{   ?>
<option value="<?php echo htmlentities($result->id); ?>"><?php echo htmlentities($result->ClassNameNumeric); ?>&nbsp; - <?php echo htmlentities($result->ClassName); ?></option>
<?php }} ?>
 </select>
                                                        </div>
                                                    </div>
