...
$sql="update tblresult4  set marks=:mrks where id=:iid ";
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (notification) {
                setTimeout(function () {
                    ...
                    window.location.href = 'manage-results-4.php';
...
$ret = "SELECT tblstudents4.StudentName,tblclasses4.ClassNameNumeric,tblclasses4.ClassName from tblresult4 join tblstudents4 on tblresult4.StudentId=tblresult4.StudentId join tblsubjects4 on tblsubjects4.id=tblresult4.SubjectId join tblclasses4 on tblclasses4.id=tblstudents4.ClassId where tblstudents4.StudentId=:stid limit 1";
...
<?php 
$sql = "SELECT distinct tblstudents4.StudentName,tblstudents4.StudentId,tblclasses4.ClassNameNumeric,tblclasses4.ClassName,tblsubjects4.SubjectName,tblresult4.marks,tblresult4.id as resultid from tblresult4 join tblstudents4 on tblstudents4.StudentId=tblresult4.StudentId join tblsubjects4 on tblsubjects4.id=tblresult4.SubjectId join tblclasses4 on tblclasses4.id=tblstudents4.ClassId where tblstudents4.StudentId=:stid ";
$query = $dbh->prepare($sql);
