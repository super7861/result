...
$sql="update  tblclasses2 set ClassNameNumeric=:classnamenumeric,ClassName=:classname where id=:cid ";
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (notification) {
                setTimeout(function () {
                    ...
                    window.location.href = 'manage-classes-2.php';
...
<?php 
$cid=intval($_GET['classid']);
$sql = "SELECT * from tblclasses2 where id=:cid";
$query = $dbh->prepare($sql);
$query->bindParam(':cid',$cid,PDO::PARAM_STR);
$query->execute();
