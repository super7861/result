...
$mark=$_POST['marks'];
 ...
 $stmt = $dbh->prepare("SELECT tblsubjects3.SubjectName,tblsubjects3.id FROM tblsubjectcombination3 join  tblsubjects3 on  tblsubjects3.id=tblsubjectcombination3.SubjectId WHERE tblsubjectcombination3.ClassId=:cid order by tblsubjects3.SubjectName");
...
for($i=0;$i<count($mark);$i++){
    $mar=$mark[$i];
  $sid=$sid1[$i];
$sql="INSERT INTO  tblresult3(StudentId,ClassId,SubjectId,marks) VALUES(:studentid,:class,:sid,:marks)";
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Declare Model Exam</h2>
...
<?php $sql = "SELECT * from tblclasses3";
$query = $dbh->prepare($sql);
$query->execute();
