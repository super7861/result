                                        ...
                                        <div class="panel">
                                            <div class="panel-heading">
                                                <div class="panel-title">
                                                    <h3 align="center">Internal test-1</h3>
                                                    <hr />
<?php
// code Student Data
$rollid=$_POST['rollid'];
...
$qery = "SELECT   tblstudents.StudentName, tblstudents.RollId, tblstudents.RegDate, tblstudents.StudentId, tblstudents.Status, tblstudents.DOB, tblclasses.ClassNameNumeric, tblclasses.ClassName
         FROM tblstudents
         JOIN tblclasses ON tblclasses.id=tblstudents.ClassId
         WHERE tblstudents.RollId=:rollid AND tblstudents.ClassId=:classid OR tblstudents.DOB=:dob"; // Add condition for DOB
