...
$sql="update  tblsubjects2 set SubjectName=:subjectname,SubjectCode=:subjectcode where id=:sid";
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (notification) {
                setTimeout(function () {
                    ...
                    window.location.href = 'manage-subjects-2.php';
...
<?php } ?>
 ...
 <?php
$sid=intval($_GET['subjectid']);
$sql = "SELECT * from tblsubjects2 where id=:sid";
$query = $dbh->prepare($sql);
$query->bindParam(':sid',$sid,PDO::PARAM_STR);
$query->execute();
