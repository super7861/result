...
$sql="update  tblclasses4 set ClassNameNumeric=:classnamenumeric,ClassName=:classname where id=:cid ";
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (notification) {
                setTimeout(function () {
                    ...
                    window.location.href = 'manage-classes-4.php';
...
<?php 
$cid=intval($_GET['classid']);
$sql = "SELECT * from tblclasses4 where id=:cid";
$query = $dbh->prepare($sql);
$query->bindParam(':cid',$cid,PDO::PARAM_STR);
$query->execute();
...
{   ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                            ...
                                                            <span class="help-block">Eg- IT,EEC,MECH etc</span>
                                                		</div>
                                                	</div>
