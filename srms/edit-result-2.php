...
$sql="update tblresult2  set marks=:mrks where id=:iid ";
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (notification) {
                setTimeout(function () {
                    ...
                    window.location.href = 'manage-results-2.php';
...
$ret = "SELECT tblstudents2.StudentName,tblclasses2.ClassNameNumeric,tblclasses2.ClassName from tblresult2 join tblstudents2 on tblresult2.StudentId=tblresult2.StudentId join tblsubjects2 on tblsubjects2.id=tblresult2.SubjectId join tblclasses2 on tblclasses2.id=tblstudents2.ClassId where tblstudents2.StudentId=:stid limit 1";
...
<?php 
$sql = "SELECT distinct tblstudents2.StudentName,tblstudents2.StudentId,tblclasses2.ClassNameNumeric,tblclasses2.ClassName,tblsubjects2.SubjectName,tblresult2.marks,tblresult2.id as resultid from tblresult2 join tblstudents2 on tblstudents2.StudentId=tblresult2.StudentId join tblsubjects2 on tblsubjects2.id=tblresult2.SubjectId join tblclasses2 on tblclasses2.id=tblstudents2.ClassId where tblstudents2.StudentId=:stid ";
$query = $dbh->prepare($sql);
