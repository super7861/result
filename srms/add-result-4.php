...
$mark=$_POST['marks'];
 ...
 $stmt = $dbh->prepare("SELECT tblsubjects4.SubjectName,tblsubjects4.id FROM tblsubjectcombination4 join  tblsubjects4 on  tblsubjects4.id=tblsubjectcombination4.SubjectId WHERE tblsubjectcombination4.ClassId=:cid order by tblsubjects4.SubjectName");
...
for($i=0;$i<count($mark);$i++){
    $mar=$mark[$i];
  $sid=$sid1[$i];
$sql="INSERT INTO  tblresult4(StudentId,ClassId,SubjectId,marks) VALUES(:studentid,:class,:sid,:marks)";
                    ...
                    <div class="main-page">
                     ...
                     <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Declare Board Exam</h2>
...
<?php $sql = "SELECT * from tblclasses4";
$query = $dbh->prepare($sql);
$query->execute();
